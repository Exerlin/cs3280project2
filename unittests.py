...
class TestUtilsTests(unittest.TestCase):
    ...
    def test_grab_query(self):
        self.assertEqual(utils.grab_ip_address('/subnet?192.131.131.15&255.0.0.0'), '192.131.131.15&255.0.0.0')
        self.assertEqual(utils.grab_ip_address('/subnet?192.131.131.15&2'), '192.131.131.15&2')
